...
namespace FIXED_POINTS_DETAILS
{
	...
	{
		static inline uint8_t Random() { return static_cast<uint8_t>(random(0xFF)); }
	};
	
	template<>
	struct RandomHelper<uint16_t>
	{
		static inline uint16_t Random() { return static_cast<uint16_t>(random(0xFFFF)); }
	};
	
	template<>
	struct RandomHelper<uint32_t>
	{
		static inline uint32_t Random() { return static_cast<uint32_t>(random(0xFFFFFFFF)); }
	};
	
	template<>
	struct RandomHelper<uint64_t>
	{
		static inline uint64_t Random() { return (static_cast<uint64_t>(random(0xFFFFFFFF)) << 32) | static_cast<uint64_t>(random(0xFFFFFFFF)); }
	};
	
	template<>
	struct RandomHelper<int8_t>
	{
		static inline int8_t Random() { return static_cast<int8_t>(random(0xFF)); }
	};
	
	template<>
	struct RandomHelper<int16_t>
	{
		static inline int16_t Random() { return static_cast<int16_t>(random(0xFFFF)); }
	};
	
	template<>
	struct RandomHelper<int32_t>
	{
		static inline int32_t Random() { return static_cast<int32_t>(random(0xFFFFFFFF)); }
	};
	
	template<>
	struct RandomHelper<int64_t>
	{
		static inline int64_t Random() { return (static_cast<int64_t>(random(0xFFFFFFFF)) << 32) | static_cast<int64_t>(random(0xFFFFFFFF)); }
	};
#endif
